// NeoPixel Functions
Adafruit_NeoPixel strip = Adafruit_NeoPixel(48, 23, NEO_GRB + NEO_KHZ800); // 48 Pixels on Pin 4

// NeoPixel Address Arrays for Buttons
int pixelButtons[6][4]{ // 6 Buttons w/ 4 LEDs Per Button
  {0, 1, 2, 3},         // BUTTON 1        *** EDIT ***
  {4, 5, 6, 7},         // BUTTON 2        *** EDIT ***
  {8, 9, 10, 11},       // BUTTON 3        *** EDIT ***
  {20, 21, 22, 23},     // BUTTON 4        *** EDIT ***
  {16, 17, 18, 19},     // BUTTON 5        *** EDIT ***
  {12, 13, 14, 15},     // BUTTON 6        *** EDIT ***
};

// NeoPixel Address Arrays for Rotary Encoders
int pixelRotary[3][8]{    // 3 Rotary Encoders w/ 8 LEDs Per Encoder           
  {32, 33, 34, 35, 36, 37, 38, 39}, // ROTARY 1    *** EDIT ***
  {24, 25, 26, 27, 28, 29, 30, 31}, // ROTARY 2    *** EDIT ***
  {40, 41, 42, 43, 44, 45, 46, 47}, // ROTARY 3    *** EDIT ***
};
